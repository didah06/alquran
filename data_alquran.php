  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
     ...
     <section class="content-header">
      ...
      <div class="row">
      <button  class="btn btn-warning "><a class="btn btn-warning"  href="preprosesing.php">preprosesing</a></button>
      <div class="col-md-12">
      <div class="box">
                 ...
                 <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php echo $row['terjemahan_ayat']; ?></td>
                      <td><?php echo $row['SuraID'];?></td>
                      <td><?php echo $row['no_ayat']; ?></td>
